...
public class ProcessBuilderExample1 {
    ...
    public static void main(String[] args) {
        ...
        // Windows
        processBuilder.command("bash", "-c", "aws cloudformation package --template-file sam.yaml --output-template-file output-sam.yaml --s3-bucket aws-serverless-springboot-petstore-1 ; aws cloudformation deploy --template-file output-sam.yaml --stack-name ServerlessSpringBootSample --capabilities CAPABILITY_IAM ; aws cloudformation describe-stacks --stack-name ServerlessSpringBootSample");
